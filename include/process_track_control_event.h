...
template <>
typename ProcessTrackControl<events::application_event::event_type, 8>::button_handler
ProcessTrackControl<events::application_event::event_type, 8>::button_handlers[8] = {
